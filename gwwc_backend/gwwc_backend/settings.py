"""
Django settings for gwwc_backend project.
...
ROOT_URLCONF = 'gwwc_backend.urls'
...
WSGI_APPLICATION = 'gwwc_backend.wsgi.application'
...
STATIC_URL = '/static/'
# STATIC_ROOT = os.path.join(BASE_DIR, "..", "gwwc_frontend")
# STATICFILES_DIRS = [
#     os.path.join(BASE_DIR, "..", "gwwc_frontend")
# ]
